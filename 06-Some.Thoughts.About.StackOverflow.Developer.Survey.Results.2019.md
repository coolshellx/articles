# 对于 《StackOverflow 2019程序员调查报告》的一些感想

前些天，StackOverflow 发布了 [2019年的年度程序员调查](https://insights.stackoverflow.com/survey/2019)，这个调查报查有9万名程序员参与，这份调度报告平均花了20分钟，可见，这份报告有很多的问题，也是很详细的。这份报告有一些地方，让我有了一些思考。
...
![](./images/06-01.Developers.Rols.png)
...
|学习编程的年限|编程的年限|
|---|---|
|![](./images/06-03.Years.Since.Learning.to.Code.png) |![](./images/06-04.Years.Coding.Professionally.png)|
...
|最流行的语言|最热门的语言|
|----|----|
|![](./images/06-06.Popular.Languages.png) | ![](./images/06-07.Loved.Languages.png)|
...
![](./images/06-08.Technology.Circle.png)
